      ...
      >
        <div
          className={cn(
            ...
            "after:bg-[radial-gradient(circle_at_50%_50%,rgba(20,184,166,0.2),transparent_70%)]"
          )}
        />
      </motion.div>
    </motion.div>
...
function HeroGeometric({
  ...
  title1 = "Welcome to",
  title2 = "Safe Harbor",
  description = "Crafting exceptional experiences for families",
  onGetStarted,
}: {
  badge?: string;
  title1?: string;
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6">
        <div className="max-w-3xl mx-auto text-center">
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/[0.08] border border-primary/[0.20] mb-8 md:mb-12"
          >
